"""Плотные подсети (subnet) для обратимых блоков.

Вендорено из LF-VSN (models/modules/Subnet_constructor.py). Единственная правка —
убран `from basicsr.archs.arch_util import ...`: в forward-пути VSN он не используется,
так что тяжёлую зависимость basicsr тащить не нужно.
"""

import torch
import torch.nn as nn

from stego.engines.lfvsn.model import module_util as mutil
